    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form class="user" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select id="id_termo" class="custom-select termo" name="venda_termos">
                    ...
                    <div class="mt-3">
                        <?php if ($venda->venda_status == 'ABERTA') : ?>
                            <button class="btn btn-primary btn-sm mr-2" type="submit"> <i class="fas fa-save"></i> Salvar</button>
