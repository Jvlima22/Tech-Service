                            ...
                            <?php foreach ($vendas as $venda) : ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a title="Visualizar" href="<?php echo base_url('vendas/view/' . $venda->venda_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i></a>
                                        <?php if ($venda->venda_status == 'ABERTA') : ?>
                                            <a title="Editar" href="<?php echo base_url('vendas/edit/' . $venda->venda_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-pen"></i></a>
                                            <a title="Faturar" href="<?php echo base_url('vendas/faturar/' . $venda->venda_id); ?>" class="btn btn-sm btn-success"><i class="fas fa-check"></i></a>
