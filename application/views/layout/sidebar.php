...
-->
    <!-- Sidebar - Brand -->
    <div class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/'); ?>">
        <div class="sidebar-brand-icon">
            <i class="fas fa-laptop"></i>
        </div>
        <div class="sidebar-brand-text mx-2">Tech Service</div>
</div>
    ...
    <!-- Heading -->
    <a class="sidebar-heading" style="color: white; font-size: 12px;text-decoration: none;" href="<?php echo base_url('/'); ?>"><i class="fas fa-home"></i>
    Início
    </a>

    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOs" aria-expanded="true" aria-controls="collapseTwo" style="margin-top: 15px">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a title="Gerenciar termos" class="collapse-item" href="<?php echo base_url('termos'); ?>"><i class="fas fa-file-contract text-gray-900"></i>&nbsp;&nbsp;Termos</a>
            </div>
        </div>
    </li>
    ...
    <?php endif; ?>
    <!--<div class="sidebar-brand d-flex align-items-center justify-content-center"> <p style="color: white; font-size: 10px;">Versão 2.0</p></div>-->
