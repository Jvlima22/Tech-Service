    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova forma de pagamento" href="<?php echo base_url('modulo/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i>&nbsp;Nova forma de pagamento</a>
            </div>
            <div class="card-body">
