...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row p-0">
            <div class="card col-2" style="min-height: 30vh; max-height: 40vh; margin-right: 0.5rem; margin-left: -0.5rem;">
                <div class="card-body" >
                    <img src="<?= base_url('public/img/uploads/'.$sistema->sistema_logo) ?>" alt="" srcset="" style="width: 100%; height:fit-content;">
                </div>
            </div>

            <!-- DataTales Example -->
            <div class="card col-10 shadow mb-4">
                <div class="card-body">

                    <form class="user" method="POST" name="form_edit" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control-file" id="exampleFormControlFile1" name="sistema_logo">
                            </div>
                        </div>
