            ...
            <div class="card-body">
                ...
                <form class="user" action="" id="form" name="form_edit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <fieldset id="vendas" class="mt-4 border p-2">
                        ...
                        <h5>Ordem Nº<?= $ordem_servico->ordem_servico_id ?></h5>
                        ...
                        <div class="">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="custom-select" name="ordem_servico_status" <?= ($ordem_servico->ordem_servico_status == 1) ? 'disabled' : '' ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 mb-1 mb-sm-0 col-md-6 col-lg-6">
                                ...
                                <div class="col-sm-12 mb-1 mb-sm-0 col-md-6 col-lg-6">
                                    ...
                                    <select id="id_termo" class="custom-select termo" name="ordem_servico_termos">
                                        <!-- <option value="">Escolha</option> -->
                                        <?php foreach ($termos as $termo) : ?>
                                            <option value="<?= $termo->id; ?>" <?= ($termo->id == $ordem_servico->ordem_servico_termos) ? 'selected' : '' ?>><?= $termo->titulo; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
