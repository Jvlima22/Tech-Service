    ...
    $("#buscar_produtos").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Produto não encontrado') {
                ...
                var i = ++$counter;
                var markup = '<tr>\
                    <td><input type="hidden" name="produto_id[]" value="' + produto_id + '" data-cell="A' + i + '" data-format="0"></td>\
                    <td><input title="Descrição do produto" type="text" name="produto_descricao[]" value="' + produto_descricao + '" class="produto_descricao form-control form-control-user input-sm" data-cell="B' + i + '" ></td>\
                    <td><input title="Valor unitário do produto" name="produto_preco_venda[]" value="' + produto_preco_venda + '" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C' + i + '" data-format="R$ 0,0.00"></td>\
                    <td><input title="Digite a quantidade apenas em número inteiros" type="number" max="'+ produto_qtde_estoque +'" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" name="produto_quantidade[]" value="" class="qty form-control form-control-user text-center" data-cell="D' + i + '" data-format="0[.]00" required></td>\
                    ...
                    <td><input title="Valor total do produto selecionado" name="produto_item_total[]" class="form-control form-control-user input-sm text-right pr-1" data-cell="F' + i + '" data-format="R$ 0,0.00" data-formula="D' + i + '*(C' + i + '-(C' + i + '*E' + i + '))" ></td>\
